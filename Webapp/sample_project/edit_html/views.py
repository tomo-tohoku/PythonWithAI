        ...
        if "get-it-now" in request.POST:
            ...
            with sync_playwright() as p:
                ...
                try:
                    ...
                    # </head>
                    # <body>
                    #     <nav class="navbar navbar-expand-lg p-0 navbar-light bg-light fixed-top" style="background-color: rgba(255, 255, 255, 0.8);">
                    ...
                    #       <!-- カードの枠：card -->
                    #       <div class="row">
                    #         <div class="card col m-3" style="background-color: rgba(255, 255, 255, 0.8);">
                    #           <!-- カード上部にレイアウトされる画像：card-img-top -->
                    #           <!-- <img class="card-img-top" src="https://via.placeholder.com/318x180.png&text=img" alt="..."> -->
                    #           <!-- カード本文：card-body -->
                    #           <div class="card-body">
                    #             <!-- カード見出し：card-title -->
                    #             <h4 class="card-title">カードの見出し</h4>
                    #             <!-- カードの副見出し：card-subtitle -->
